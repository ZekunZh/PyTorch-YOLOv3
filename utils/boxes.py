...
def xyxy_to_xywh_yolo(xyxy, height, width):
    """Convert [x1 y1 x2 y2] box format to [x_center/img_w y_center/img_h w/img_w h/img_h] in yolo format."""
    if isinstance(xyxy, (list, tuple)):
        assert len(xyxy) == 4
        ...
        raise TypeError('Argument xyxy must be a list, tuple.')
