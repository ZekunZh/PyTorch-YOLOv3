...
parser.add_argument('--config_path', type=str, default='config/radio.cfg', help='path to model config file')
...
model.load_weights(opt.weights_path, from_numpy=False, change_num_classes=False)
